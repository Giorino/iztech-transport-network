...
import com.izmir.transportation.helper.clustering.leiden.util.LargeBooleanArray;
...
import com.izmir.transportation.helper.clustering.leiden.util.LargeLongArray;
...
public class Network implements Serializable
{
    ...
    {
        return com.izmir.transportation.helper.clustering.leiden.util.Arrays.calcSum(nodeWeights);
    }
    ...
    public Network createNetworkWithoutNodeWeights()
    {
        ...
        networkWithoutNodeWeights.nodeWeights = com.izmir.transportation.helper.clustering.leiden.util.Arrays.createDoubleArrayOfOnes(nNodes);
    ...
    public Network createNetworkWithoutNodeAndEdgeWeights()
    {
        ...
        networkWithoutNodeAndEdgeWeights.nodeWeights = com.izmir.transportation.helper.clustering.leiden.util.Arrays.createDoubleArrayOfOnes(nNodes);
    ...
    public Network createNormalizedNetworkUsingAssociationStrength()
    {
        ...
        normalizedNetwork.nodeWeights = com.izmir.transportation.helper.clustering.leiden.util.Arrays.createDoubleArrayOfOnes(nNodes);
	...
	this.neighbors.resize(nEdges); this.neighbors.shrink();
        ...
        this.nodeWeights = (nodeWeights != null) ? nodeWeights.clone() : (setNodeWeightsToTotalEdgeWeights ? getTotalEdgeWeightPerNodeHelper() : com.izmir.transportation.helper.clustering.leiden.util.Arrays.createDoubleArrayOfOnes(nNodes));
