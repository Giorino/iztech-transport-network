...
public class Clustering implements Cloneable, Serializable
{
    ...
    public Clustering(int[] clusters)
    {
        ...
        nClusters = com.izmir.transportation.helper.clustering.leiden.util.Arrays.calcMaximum(clusters) + 1;
    }
   ...
   /**
    ...
    {
        orderClustersByWeight(com.izmir.transportation.helper.clustering.leiden.util.Arrays.createDoubleArrayOfOnes(nNodes));
    }
