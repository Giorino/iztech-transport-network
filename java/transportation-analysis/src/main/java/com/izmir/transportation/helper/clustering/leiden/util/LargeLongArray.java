package com.izmir.transportation.helper.clustering.leiden.util;
...
public final class LargeLongArray implements Cloneable, Iterable<Long>
{
    ...
    public LargeLongArray(long size)
    {
        ...
        this.values = new long[nSegments][];
        ...
        while (remainingLength > MAX_SIZE_ARRAY)
        {
            ...
            this.values[segment] = new long[MAX_SIZE_ARRAY];
        ...
        if (remainingLength > 0)
            this.values[segment] = new long[(int)remainingLength];
    }
     ...
     */
    public LargeLongArray(long size, long constant)
    {
        this(size);
     ...
     */
    public LargeLongArray(long[] values)
    {
        this(values.length);
     ...
     * @return Value of element
     */
    public long get(int segment, int offset)
    {
     ...
     * @param value   Value
     */
    public void set(int segment, int offset, long value)
    {
     ...
     */
    public void fill(long constant)
    {
    ...
    public void ensureCapacity(long minCapacity)
    {
        ...
        if (minCapacity > oldCapacity)
        {
            ...
            while (remainingLength > MAX_SIZE_ARRAY)
            {
                ...
                // MAX_SIZE_ARRAY
                newValues[segment] = new long[MAX_SIZE_ARRAY];
            ...
            if (remainingLength > 0)
                newValues[segment] = new long[(int)remainingLength];
     ...
     */
    public void subtract(long index, long subtraction)
    {
     ...
     */
    public void multiply(long index, long multiplier)
    {
     ...
     */
    public void divide(long index, long divisor)
    {
     ...
     */
    public void updateFrom(LargeLongArray array)
    {
     ...
     * @return Cloned array
     */
    public LargeLongArray clone()
    {
        LargeLongArray clonedArray;
     ...
     */
    public class FromIterable implements Iterable<Long>
    {
        long from;
     ...
     */
    public class FromToIterable implements Iterable<Long>
    {
        long from;
        long to;
    ...
    public class Iterator implements PrimitiveIterator.OfLong
    {
        ...
        public Iterator(long from, long to)
        {
            ...
            if (segment == maxSegment)
                ...
                currentMaxOffset = LargeLongArray.MAX_SIZE_ARRAY;
