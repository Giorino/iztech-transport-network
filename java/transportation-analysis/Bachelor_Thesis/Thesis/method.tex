...
After identifying the optimal clustering approach, which was determined to be the Gabriel graph construction with the Leiden algorithm, we conducted a robustness analysis to further optimize the transportation costs. By systematically varying the standard deviation threshold for outlier detection, we investigated the relationship between the number of excluded outliers and the total transportation cost.
